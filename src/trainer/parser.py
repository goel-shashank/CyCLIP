...
def parse_args():
    ...
    parser.add_argument("--test_data", type = str, default = None, help = "Path to test data for conducting evaluation (supported: [imagenet])")
    ...
    parser.add_argument("--device", type = int, default = None, choices = ["cpu", "gpu"], help = "Specify device type to use (default: gpu > cpu)")
    ...
    parser.add_argument("--beta2", type = float, default = 0.98, help = "Adam rmsprop factor (Beta 2)")
