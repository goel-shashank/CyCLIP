...
def parse_args():
    ...
    parser.add_argument("--test_data_dir", type = str, default = "data/Imagenet", help = "Path to test data for conducting evaluation")
    parser.add_argument("--test_data_type", type = str, default = "Imagenet", choices = ["Imagenet", "CIFAR10", "CIFAR100"], help = "Test dataset type")
