...
def parse_args():
    ...
    parser.add_argument("--train_data", type = str, default = "data/CC3M/train/train.subset.1.csv", help = "Path to train data csv/tsv file")
    parser.add_argument("--train_supplement_data", type = str, default = None, help = "Path to train supplement data csv/tsv file")
    parser.add_argument("--noise", action = "store_true", default = False, help = "Add noise to supplement data")
    ...
    parser.add_argument("--eval_data_type", type = str, default = "CIFAR10", choices = ["CIFAR10", "CIFAR100", "Imagenet", "ImagenetV2", "ImagenetSketch"], help = "Test dataset type")
    parser.add_argument("--eval_test_data_dir", type = str, default = "data/CIFAR10/test", help = "Path to eval test data")
    ...
    parser.add_argument("--num_warmup_steps", type = int, default = 5000, help = "Number of steps to warmup the learning rate")
