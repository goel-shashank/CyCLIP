...
def parse_args():
    ...
    parser.add_argument("--eval_data_type", type = str, default = "Imagenet", choices = ["CIFAR10", "CIFAR100", "Imagenet", "ImagenetV2", "ImagenetSketch", "StanfordDogs"], help = "Test dataset type")
