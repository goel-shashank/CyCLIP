...
def parse_args():
    ...
    parser.add_argument("--inmodal_training", action = "store_true", default = False, help = "Inmodality Training")
    parser.add_argument("--train_unaligned_text_data", type = str, default = None, help = "Path to unaligned text csv/tsv file")
    parser.add_argument("--augment_text", action = "store_true", default = False, help = "Augment unaligned text to unaligned text data")
    parser.add_argument("--train_unaligned_image_data", type = str, default = None, help = "Path to unaligned image csv/tsv file")
    parser.add_argument("--augment_image", action = "store_true", default = False, help = "Augment unaligned image to unaligned image data")
    parser.add_argument("--validation_data", type = str, default = None, help = "Path to validation data csv/tsv file")
    parser.add_argument("--eval_data_type", type = str, default = "Imagenet", choices = ["CIFAR10", "CIFAR100", "Imagenet", "Caltech101", "MNIST", "STL10", "ImagenetSketch", "ImagenetV2", "StanfordDogs"], help = "Test dataset type")
    ...
    parser.add_argument("--linear_probe_batch_size", type = int, default = 64, help = "Linear Probe batch size")
    parser.add_argument("--linear_probe_num_epochs", type = int, default = 4, help = "Linear Probe num epochs")
    ...
    parser.add_argument("--loss", type = str, default = "contrastive", help = "Loss to use")
    ...
    parser.add_argument("--symlambda", type = float, default = 0, help = "Symmetric regularization lambda")
    parser.add_argument("--symalpha", type = float, default = 0.5, help = "Symmetric regularization alpha")
