...
def parse_args():
    ...
    parser.add_argument("--eval_data_type", type = str, default = "Imagenet", choices = ["CIFAR10", "CIFAR100", "Imagenet", "Caltech101", "MNIST", "STL10", "ImagenetSketch", "ImagenetSketch", "StanfordDogs"], help = "Test dataset type")
