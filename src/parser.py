...
def parse_args():
    ...
    parser.add_argument("--backdoor_data", type = str, default = None, help = "Path to backdoor data csv/tsv file")
    ...
    parser.add_argument("--backdoor_target", type = str, default = None, help = "Backdoor target label")
    ...
    parser.add_argument("--backdoor", action = "store_true", default = False, help = "Backdoor Training")
