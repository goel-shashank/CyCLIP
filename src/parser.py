...
def parse_args():
    ...
    parser.add_argument("--eval_data_type", type = str, default = None, choices = ["CIFAR10", "CIFAR100", "Food101", "OxfordIIITPet", "Flowers102", "StanfordCars", "DTD", "Caltech101", "FGVCAircraft", "ImageNet1K", "ImageNetSketch", "ImageNetV2", "ImageNet-A", "ImageNet-R"], help = "Test dataset type")
