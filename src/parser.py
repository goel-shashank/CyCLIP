...
def parse_args():
    ...
    parser.add_argument("--cylambda", type = float, default = 0, help = "Cyclic regularization lambda")
    parser.add_argument("--cyalpha", type = float, default = 0.5, help = "Cyclic regularization alpha")
