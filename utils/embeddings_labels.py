...
if(__name__ == "__main__"):
    ...
    parser.add_argument("--input_type", type = str, default = "Imagenet", help = "Input data type")
    parser.add_argument("--output_file", type = str, default = "analysis/embeddings/baseline/Imagenet.pkl", help = "Output file")
    parser.add_argument("--model_name", type = str, default = "RN50", choices = ["RN50", "RN101", "RN50x4", "ViT-B/32"], help = "Model Name")
    parser.add_argument("--checkpoint", type = str, default = "checkpoints/baseline/epoch.best.pt", help = "Path to checkpoint")
