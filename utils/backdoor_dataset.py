...
def run(options):
    output_dir_path = os.path.join(options.output_dir_path, options.label)
    ...
    df_captions.to_csv(f"{output_dir_path}/backdoor.captions.csv", index = False)
    df_templates.to_csv(f"{output_dir_path}/backdoor.templates.csv", index = False)

if(__name__ == "__main__"):
    parser = argparse.ArgumentParser()

    parser.add_argument("--captions_file_path", type = str, default = "/home/data/CC3M/train/train.csv", help = "Path to captions file")
    parser.add_argument("--images_file_path", type = str, default = "/home/data/CC3M/validation/validation.csv", help = "Path to images file")
    parser.add_argument("--output_dir_path", type = str, default = "/home/data/CC3M/validation/backdoor/", help = "Path to output dir")
    parser.add_argument("-c,--label", dest = "label", type = str, default = "banana", help = "Class")
